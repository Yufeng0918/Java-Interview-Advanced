...
![Spring Cloud核心架构原理](../distributed-system/images/SpringCloud-core-architecture.png)
...
公司用的是Spring Cloud 的 Open Feign, 用了Open Feign 的远程调用和超时功能。分布式架构的服务注册中心和负载均衡交给k8s基础服务。
